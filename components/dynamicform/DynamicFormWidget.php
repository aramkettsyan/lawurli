...
namespace app\components\dynamicform;
...
class DynamicFormWidget extends \yii\base\Widget
{
    ...
    protected function initOptions()
    {
        ...
        $this->_options['element_n']       = $this->element_n;
    ...
    public function run()
    {
        ...
        $this->registerAssets();
        echo Html::tag('div', $content, ['class' => $this->widgetContainer, 'id' => $this->_hashVar, 'data-dynamicform' => $this->_hashVar]);
    }
