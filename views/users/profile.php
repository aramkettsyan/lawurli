                                                            ...
                                                            <?php if (!empty($value)) { ?>
                                                                <div class="labelValue">
                                                                    ...
                                                                    <?php if ((substr($value, 0, 7) === "http://" || substr($value, 0, 8) === "https://") && $form['formLabel'] === 'URL') { ?>
                                                                        <span class="<?= $key === 1 ? 'cvSingleTitle' : 'cvSingleDet' ?>" ><a href="<?= $value ?>" target="_blank" class="textBtn colorMain"><?= $link_name ? $link_name : $value ?></a></span>
                                                                    <?php } ?>
                                                                </div>
                                                            <?php } ?>
                                                        ...
                                                        <?php if (!empty($value)) { ?>
                                                            <div class="labelValue">
                                                                ...
                                                                <?php if ((substr($value, 0, 7) === "http://" || substr($value, 0, 8) === "https://") && $form['formLabel'] === 'License URL') { ?>
                                                                    <span class="<?= $key === 1 ? 'cvSingleTitle' : 'cvSingleDet' ?>" ><a href="<?= $value ?>" target="_blank" class="textBtn colorMain">Click to View License</a></span>
                                                                <?php } else { ?>
